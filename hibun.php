...
//manageLayout("hokku_side.cfg");  
//manageLayout($gasLayoutStyle,$gasContentStyle,array("index.cfg"));  
//writeMainMenu($gasConfig,$gasMainMenuStyle,$gasMainMenuItems) ;
// manageLayout - вот как сделать надо. 
?>                    
</td>
...
<!-- Контент -->
<?php 
  //$lasLayouts=array("internet.cfg");
  //manageLayout($gasLayoutStyle,$gasContentStyle,$lasLayouts);  

  manageLayout("hibun.cfg");  
  //manageLayout($gasLayoutStyle,$gasContentStyle,"internet.cfg");  lalala
 ?>
